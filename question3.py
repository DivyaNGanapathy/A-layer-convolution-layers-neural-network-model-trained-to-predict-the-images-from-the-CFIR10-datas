...
Original file is located at
    https://colab.research.google.com/drive/10u_mzKR5pHTjJXGkpXFNCZACjvIOOOdY
"""
...
''' multiple fully connected layers. Try having a layer from input to 120 neurons
and then a layer to 84 neurons, and finally a layer to 10 neurons, one for each category.'''

#Network without ReLU
class MulFCNoReluQ3(nn.Module):
    def __init__(self):
        super(MulFCNoReluQ3, self).__init__()
    ...
    def forward(self, x):
        ...
        return x
#Network with ReLU
class MulFCReluQ3(nn.Module):
    def __init__(self):
        super(MulFCReluQ3, self).__init__()
        self.fc1 = nn.Linear(32*32*3, 120)
        self.fc2 = nn.Linear(120, 84)
        self.fc3 = nn.Linear(84, 10)
...
#An optimizer is used and the loss function used is Cross Entropy . We are using a Learning Rate of 0.001 and a Batch size of 4
...
#Function for network withoutRelu
  net = MulFCNoReluQ3()
