...
Original file is located at
    https://colab.research.google.com/drive/1gxAcvFimmNlaxmNudoFv0Hu2JilGA8AZ
"""
...
#Adding Data Augumentation on training Data but resizing and flipping the data inorder to reduce overfit.
...
#Standard Gradient Descent as the optimizer 
  ...
  trainset_new = torchvision.datasets.CIFAR10(root='./data', train=True, download=True, transform=transform_new)
  train_predict = torch.utils.data.DataLoader(trainset_new, batch_size=4, shuffle=True, num_workers=0)
  net = NetFCQ1Q4()
