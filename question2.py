...
Original file is located at
    https://colab.research.google.com/drive/1sOWX6fuA_Tdx2DRK8K2StdW11jTuS-kZ
"""
...
#Class for a Single Fully connected Network
#32 by 32-Size of the image , 3-Channels
class NetFCSingleQ2(nn.Module):
  def __init__(self):
    super(NetFCSingleQ2, self).__init__()
...
def AccuracyCheck(trainloader, testloader, net, criterion, optimizer, batch_size, classes):
    ...
    device = torch.device("cpu" if torch.cuda.is_available() else "cpu")# Here We are using GPU 
    print(device)
    net.to(device)
    loss_lst = []
    accuracy_testList = []
