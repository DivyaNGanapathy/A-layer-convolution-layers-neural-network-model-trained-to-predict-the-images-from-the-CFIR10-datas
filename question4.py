...
Original file is located at
    https://colab.research.google.com/drive/1FrDdkuT-WiHuSjSYffSuLlmYivuds7sC
"""
...
#Class for a  Fully connected Network with 2 Convlutional Network and max pooling layers. Here we are also using Relu 
